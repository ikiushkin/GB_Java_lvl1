...
public class Lesson2 {
    ...
    public static void checkBalance (int[] arrTask6) {
        ...
        int leftHalf = arrTask6[0];
        int rightHalf = arrTask6[arrTask6.length-2] + arrTask6[arrTask6.length-1];

        for (int i = 1; i < arrTask6.length-2; i ++) {
            leftHalf = leftHalf + arrTask6[i];
        }
